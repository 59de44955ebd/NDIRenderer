...
#define _VER_ORIGINALFILENAME	"NDIRenderer.ax"
#define _VER_COMPANY			"NDI"
#define _VER_FILEDESCRIPTION	"NDIRenderer DirectShow Filter"
#define _VER_PRODUCTNAME		"NDIRenderer"
#define _VER_INTERNALNAME		"NDIRenderer.ax"
